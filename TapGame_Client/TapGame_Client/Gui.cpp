...
void Gui::Run()
{
    ...
    ::RegisterClassExW(&wc);
    hwnd = ::CreateWindowW(wc.lpszClassName, L"Dear ImGui DirectX11 Example", WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800, nullptr, nullptr, wc.hInstance, this);
    ...
    while (!done)
    {
...

        {
            ...
            //GUI 구현이 안됐으니깐 일단 버튼 누르면 로그인처럼 하게 만들어 ok?
            bool send = false;
